...
exports.author_create_post = [
    ...
    body('first_name').trim().isLength({ min: 1 }).escape().withMessage('First name is required.')
        .isAlphanumeric().withMessage('First name has alpha-numeric characters'),
    body('family_name').trim().isLength({ min: 1 }).escape().withMessage('Family name is required.')
        .isAlphanumeric().withMessage('Family name has alpha-numberic characters.'),
    ...
    function (req, res, next) {
        ...
        if (!errors.isEmpty()) {
            // There are errors. Render form again with sanitized errors/values messages.
            ...
            // Data is valid.
            // Create an Author object with escapped and trimmed data.
